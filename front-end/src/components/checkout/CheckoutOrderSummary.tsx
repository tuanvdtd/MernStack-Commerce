...
/**
 * Sidebar with the order summary and place-order button on checkout.
 */
export function CheckoutOrderSummary({
  ...
  return (
    ...
    >
      <h2 className="text-base font-semibold text-[#2b2f32] sm:text-lg">Payment summary</h2>
      ...
      <div className="flex items-baseline justify-between gap-4">
        <span className="text-sm font-semibold text-[#2b2f32] sm:text-base">Total</span>
      ...
      <p className="mt-3 text-center text-xs leading-relaxed text-[#757575]">
        By placing your order, you agree to FlashBuy's Terms of Use.
      </p>
