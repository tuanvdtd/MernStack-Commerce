...
export const mockDiscounts: AdminDiscount[] = [
  ...
  {
    id: "disc-iphone50",
    name: "Giảm 50.000đ iPhone 15",
    description: "Giảm cố định 50.000đ khi mua iPhone 15 Pro Max.",
    type: "FIXED_AMOUNT",
    value: 50000,
    maxValue: 50000,
    code: "IPHONE50",
  ...
  },
  {
    ...
    description: "Giảm 200.000đ cho MacBook Pro M3 trong khung flash sale.",
    type: "FIXED_AMOUNT",
    value: 200000,
    maxValue: 200000,
    code: "FLASH200K",
  ...
  {
    id: "disc-tet15",
    name: "Tết 15% toàn sàn",
    description: "Giảm 15% toàn bộ đơn hàng, tối đa 500.000đ.",
    type: "PERCENTAGE",
    value: 15,
    maxValue: 500000,
    code: "TET2026",
  ...
  {
    id: "disc-newmember",
    name: "Thành viên mới 5%",
    description: "Ưu đãi 5% cho thành viên mới đăng ký trong tháng 7.",
    type: "PERCENTAGE",
    value: 5,
    maxValue: 50000,
    code: "NEWMEMBER",
